...
const CoursesList = () => {
  ...
  useEffect(() => {
    if(allCourses && allCourses.length > 0) {
      ...
      input ? setFilteredCourses(tempCourses.filter(item => item.courseTitle.toLowerCase().includes(input.toLowerCase())))
  ...
  return (
    ...
    <div className='relative md:px-36 px-8 pt-20 text-left'>
      ...
      {
        input && <div className='inline-flex items-center gap-4
         px-4 py-2 border mt-8 -mb-8 text-gray-600'>
          <p>{input}</p>
